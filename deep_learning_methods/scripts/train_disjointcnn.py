#!/usr/bin/env python
"""
Script to train and evaluate the DisjointCNN model for time series classification.
"""
import argparse
import os
import sys
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Train and evaluate DisjointCNN for time series classification")
...
def main():
    ...
    results = evaluate_model(model, X_train, X_test, y_train, y_test, "DisjointCNN")
    os.makedirs(args.output_dir, exist_ok=True)
    save_results(results, output_dir=args.output_dir, prefix="disjointcnn")
