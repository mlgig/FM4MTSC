...
from transformers import BertModel, BertTokenizer, GPT2ForSequenceClassification
...
class gpt4ts(nn.Module):
    def __init__(self, config, data):
        ...
        self.enc_embedding = DataEmbedding(
            self.feat_dim * self.patch_size, config["d_model"], config["dropout"]
        )
        ...
        device = "cpu"  # torch.device('cuda:{}'.format(0))
