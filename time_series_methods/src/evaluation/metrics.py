...
def evaluate_model(
    ...
    """
    Train and evaluate a time series classification model.

    Args:
        model: Time series classification model
...
def save_results(
    ...
    base_filename = os.path.join(output_dir, f"ts_classification_results_{timestamp}")
...
def write_model_results(f, result: Dict[str, Any]) -> None:
    """
    Helper function to write model results to a file.
